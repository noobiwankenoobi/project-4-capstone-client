...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://project-4-capstone-api.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// [SHOW MODALS] SECTION | [SHOW MODALS] SECTION | [SHOW MODALS] SECTION
	var onShowSignUpModal = function onShowSignUpModal(event) {
	  event.preventDefault();
	  $('#sign-up-modal').modal('show');
	};

	var onShowSignInModal = function onShowSignInModal(event) {
	  event.preventDefault();
	  $('#sign-in-modal').modal('show');
	};

	var onShowChangePasswordModal = function onShowChangePasswordModal(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var gamesEvents = __webpack_require__(13);
	var gamesApi = __webpack_require__(14);
	var gamesUi = __webpack_require__(15
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  gamesApi.getGames().then(gamesUi.getGamesSuccess).catch(gamesUi.getGamesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGoHome = function onGoHome(event) {
	  event.preventDefault();
	  $('#content').empty();
	};

	var onShowNewGameModal = function onShowNewGameModal() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var api = __webpack_require__(14);
	var gamesListViewFile = __webpack_require__(16);
	var gameInfoView = __webpack_require__(36);

	var refreshGamesData = function refreshGamesData() {
	  api.getGames().then(getGamesSuccessQuiet).catch(getGamesFailure);
	};
	...
	var getGamesSuccess = function getGamesSuccess(data) {
	  ...
	  store.wantToPlayGames = store.games.filter(function (game) {
	    return game.progress === 0;
	  });
	  store.startedGames = store.games.filter(function (game) {
	    return game.progress === 1;
	  });
	  store.completedGames = store.games.filter(function (game) {
	    return game.progress === 2;
	  });
	  var gamesListHTML = gamesListViewFile({
	  ...
	  $('.list-item-more-button').click(function () {
	    $('html,body').animate({
	      scrollTop: $('.game-info-div').offset().top }, 'slow');
	  });
	};

	var getGamesSuccessQuiet = function getGamesSuccessQuiet(data) {
	  store.games = data.games;
	  store.wantToPlayGames = store.games.filter(function (game) {
	    return game.progress === 0;
	  });
	...
	var onDeleteGame = function onDeleteGame(event) {
	  ...
	  api.deleteGame(gameId).then(deleteGameSuccess).catch(deleteGameFailure);
	};
	...
	var deleteGameFailure = function deleteGameFailure(error) {
	...
	var onChangeToWant = function onChangeToWant(event) {
	  event.preventDefault();
	  var currentSelectedGameId = $(event.target).attr('data-id');
	  var data = {
	    game: {
	      progress: 0,
	  ...
	  api.updateGame(data).then(updateGameSuccess).catch(updateGameFailure);
	};

	var onChangeToStart = function onChangeToStart(event) {
	  event.preventDefault();
	  var currentSelectedGameId = $(event.target).attr('data-id');
	  var data = {
	    game: {
	...
	var onChangeToComplete = function onChangeToComplete(event) {
	  event.preventDefault();
	  var currentSelectedGameId = $(event.target).attr('data-id');
	  var data = {
	    game: {
	...
	var onCloseGameInfo = function onCloseGameInfo(event) {
	  event.preventDefault();
	  $('#game-info-content').empty();
	};
	...
	var renderGameInfo = function renderGameInfo(currentSelectedGameId) {
	  var currentGameArray = store.games.filter(function (game) {
	    return String(game.id) === currentSelectedGameId;
	  });
	  var currentSelectedGame = currentGameArray[0];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n        <div class=\"list-item-div active hover\" data-id=\""
	    ...
	    + "</h4>\n          </div>\n          <div class=\"col-xs-5\">\n            <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-info list-item-more-button\">More</button>\n            <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-danger delete-game-button\">X</button>\n          </div>\n        </div>\n\n";
	  ...
	  return "<div class=\"container games-lists-div\">\n\n<!-- WANT TO PLAY | WANT TO PLAY | WANT TO PLAY | WANT TO PLAY | -->\n<!-- WANT TO PLAY | WANT TO PLAY | WANT TO PLAY | WANT TO PLAY | -->\n<div id=\"want-to-play-div\" class=\"container col-xs-4 list-container-div\">\n  <h2 class=\"list-header\">Want to Play</h2>\n  <div class=\"col-xs-12\">\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.wantToPlayGames : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </div>\n</div>\n\n<!-- STARTED PLAYING | STARTED PLAYING | STARTED PLAYING | STARTED PLAYING -->\n<!-- STARTED PLAYING | STARTED PLAYING | STARTED PLAYING | STARTED PLAYING -->\n\n<div id=\"started-playing-div\" class=\"container col-xs-4 list-container-div\">\n  <h2 class=\"list-header\">Started Playing</h2>\n  <div class=\"col-xs-12\">\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.startedGames : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </div>\n</div>\n\n<!-- COMPLETED | COMPLETED | COMPLETED | COMPLETED | COMPLETED | COMPLETED | -->\n<!-- COMPLETED | COMPLETED | COMPLETED | COMPLETED | COMPLETED | COMPLETED | -->\n\n<div id=\"completed-div\" class=\"container col-xs-4 list-container-div\">\n  <h2 class=\"list-header\">Completed</h2>\n  <div class=\"col-xs-12\">\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.completedGames : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </div>\n</div>\n\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "          <button id=\"want-to-play-button\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-info\">Want to Play</button>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "          <button id=\"started-playing-button\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-info\">Started Playing</button>\n";
	},"5":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "          <button id=\"completed-button\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-info\">Finished Playing</button>\n";
	  ...
	  return "<div class=\"container game-info-div\">\n\n  <div id=\"game-info-panel\" class=\"container col-xs-12\">\n\n    <div id=\"game-info-game-img-div\"class=\"container col-xs-3\">\n      <img class=\"img-thumbnail\" src=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.cover_url : stack1), depth0))
	    + "\" alt=\"Game Cover\">\n    </div>\n\n    <div class=\"container col-xs-7 game-info-text-div\">\n      <h2 class=\"game-info-text\">Game Info</h2>\n      <div class=\"container col-xs-12\">\n        <h3>Title: <strong>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</strong></h3>\n        <h4>Status: <strong>"
	    + alias2(((helper = (helper = helpers.statusName || (depth0 != null ? depth0.statusName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias3,{"name":"statusName","hash":{},"data":data}) : helper)))
	    + "</strong></h4>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-danger delete-game-button\">Delete Game</button>\n      </div>\n\n      <br>\n\n      <div class=\"container col-xs-12 update-status-buttons-div\">\n        <h4>Update Play Status</h4>\n"
	    + ((stack1 = helpers.unless.call(alias3,(depth0 != null ? depth0.isWantToPlay : depth0),{"name":"unless","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers.unless.call(alias3,(depth0 != null ? depth0.isStarted : depth0),{"name":"unless","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers.unless.call(alias3,(depth0 != null ? depth0.isCompleted : depth0),{"name":"unless","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      </div>\n\n    </div>\n\n    <div id=\"close-game-info-panel\" class=\"col-xs-1\">\n      <button id=\"close-game-info-button\" class=\"btn btn-info\">Close</button>\n    </div>\n\n  </div>\n\n</div>\n";
	},"useData":true});
